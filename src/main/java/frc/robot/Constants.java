...
public final class Constants {
	...
	public static final class DriveConstants {
		...
		public static final double kTurnMaxAcceleration = 120; // up to 360?
	...
	public static final class PoseConstants {
		...
		public static final Pose kBlueCenterNoteFourPose = new Pose(-0.2 + 0.25 + 0.2, -1.7 + 0.10, 180 + 30);
		...
		public static final Pose kRedCenterNoteFourPose = new Pose(0.2 - 0.25 - 0.2, -1.7 + 0.10, -30);
